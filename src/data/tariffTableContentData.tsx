export const tariffTableContentData: Record<
  string,
  {
    head: string;
    content: string;
...
> = {
  ...
  <thead>
    <tr>
      <th>Category</th>
      <th>Service</th>
      <th>Call Driver Per Day Rate in Chennai</th>
  ...
  <tbody>
    ...
    <tr>
      <td>In-City Normal Car Driver Rates in Chennai</td>
      <td>
        Minimum 3 Hours<br/>
        Extra Per Hour<br/>
        Night Charges<br/>
    ...
    <tr>
      <td>In-City Luxury Car Driver Rates in Chennai</td>
      <td>
        Minimum 3 Hours<br/>
        Extra Per Hour<br/>
        Night Charges<br/>
    ...
    <!-- Row 3: Valet Parking -->
    <tr>
      <td>Call Driver in Chennai for Valet Parking for Events</td>
      <td>
        Per Driver<br/>
        Extra Per Hour<br/>
    ...
    <!-- Row 4: Monthly Plans -->
    <tr>
      <td>Monthly Call Driver Plans in Chennai</td>
      <td>
        Normal Plan<br/>
        Normal Plan<br/>
        Luxury Plan<br/>
    ...
    <table class="tariff-table">
      <thead>
        <tr>
          <th>Category</th>
          <th>Service</th>
          <th>Call Driver Per Day Rate in Coimbatore</th>
          <th>Conditions Applied</th>
        </tr>
      </thead>
      <tbody>
    ...
    <table class="tariff-table">
      <thead>
        <tr>
          <th>Category</th>
          <th>Service</th>
          <th>Call Driver Per Day Rate in Madurai</th>
          <th>Conditions Applied</th>
        </tr>
      </thead>
      <tbody>
        <!-- Row 1: In-City Normal -->
        <tr>
          <td>In-City Normal Car Driver Rates in Madurai</td>
          <td>
            Minimum 3 Hours<br/>
            Extra Per Hour<br/>
            Night Charges<br/>
        ...
        <!-- Row 2: In-City Luxury -->
        <tr>
          <td>In-City Luxury Car Driver Rates in Madurai</td>
          <td>
            Minimum 3 Hours<br/>
            Extra Per Hour<br/>
            Night Charges<br/>
        ...
        <!-- Row 3: Valet Parking -->
        <tr>
          <td>Call Driver in Madurai for Valet Parking for Events</td>
          <td>
            Per Driver<br/>
            Extra Per Hour<br/>
            Supervisor (For Every 10 Drivers)
