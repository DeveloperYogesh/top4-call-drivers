  ...
  return (
    <section className="parah-content">
      <div className="custom-container max-w-[1200px]!">
        ...
        {/* In-City Tariff */}
        <h2>In-City Call Driver Rates for Normal and Luxury Cars</h2>
        ...
        {/* Outstation Tariff */}
        <h2>Driver Charges Per Day for Outstation Trips</h2>
        <p style={{ marginBottom: "16px" }}>
        ...
        <h2>Monthly Call Driver Tariff Plans</h2>
        <p style={{ marginBottom: "16px" }}>
        ...
        <div style={{ marginBottom: "24px", overflowX: "auto" }}>
          <table className="tariff-table">
            <thead>
              <tr>
                <th colSpan={2}>Plans Schedule</th>
              </tr>
            </thead>
            <tbody>
              <tr>
                <td className="header-cell">Normal - ₹22000 / (10 Hrs)</td>
                <td>Extra Hrs - ₹60</td>
              </tr>
              <tr>
                <td className="header-cell">Normal - ₹22000 / (12 Hrs)</td>
                <td>Extra Hrs - ₹60</td>
              </tr>
              <tr>
                <td className="header-cell">Luxury - ₹24000 / (10 Hrs)</td>
                <td>Extra Hrs - ₹60</td>
              </tr>
              <tr>
                <td className="header-cell">Luxury - ₹26000 / (12 Hrs)</td>
                <td>Extra Hrs - ₹60</td>
              </tr>
            </tbody>
          </table>
        ...
        {/* Benefits */}
        <h2>Benefits of Hiring Experienced Call Drivers with TOP4</h2>
