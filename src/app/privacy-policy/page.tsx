        ...
        <div className="bg-gray-50 min-h-screen py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto bg-white shadow rounded-lg p-8">
                ...
                <div className="prose prose-blue max-w-none text-gray-700 space-y-6">
                    <p>
                        Your privacy matters to Humble Mobile Solutions Private Limited (the &quot;Company&quot;, &quot;We&quot;, &quot;Top4 Call Drivers PVT LTD&quot;, or &quot;us&quot;). This Privacy Policy explains how we collect, process, use, share and protect information about you. It also tells you how you can access and update your information and make certain choices about how your information is used.
                    </p>

                    <p>
                        The Privacy Policy covers both online (e.g., web and mobile services, including any websites operated by us such as https://www.top4calldrivers.com or Mobile Application, however accessed and/or used, whether via personal computers, mobile devices or otherwise) and offline (e.g., collection of data through mailings, telephone, or in person) activities owned, operated, provided, or made available by the Company. Our online and offline activities, in relation to facilitation of services through a network of third-party service providers, are collectively referenced as the &quot;Services.&quot; This Privacy Policy also applies to your use of interactive features or downloads that: (i) we own or control; (ii) are available through the Services; or (iii) interact with the Services and post or incorporate this Privacy Policy.
                    </p>

                    <div className="bg-blue-50 p-4 rounded-md border-l-4 border-blue-500 my-6">
                    ...
                    <p>Unless otherwise provided in this Privacy Policy, the terms capitalized in the Privacy Policy shall have the meaning as provided hereunder:</p>
                    <ul className="list-disc pl-5 space-y-2">
                        <li><strong>Co-branded Services</strong> shall have the meaning assigned to the term in paragraph 4(c) hereto.</li>
                        <li><strong>Device</strong> shall mean computer, mobile or other device used to access the Services.</li>
                        <li><strong>Device Identifier</strong> shall mean IP address or other unique identifier for the Device.</li>
                        <li><strong>Mobile Application</strong> shall mean application provided by us on the Device to access the Services</li>
                        <li><strong>Mobile Device Application</strong> shall have the meaning assigned to the term in paragraph 2(5) hereto</li>
                        <li><strong>Promotion</strong> shall mean any contest and other promotions offered by us.</li>
                        <li><strong>Protected Information</strong> shall mean such categories of information that could reasonably be used to identify you personally, including your name, e-mail address, and mobile number.</li>
                        <li><strong>TPSP</strong> shall mean a third party service provider.</li>
                        <li><strong>Usage Information</strong> shall have the meaning assigned to the term in paragraph 2(b)(i) hereto.</li>
                    </ul>

                    <h2 className="text-xl font-bold text-gray-900 mt-8 mb-4">2. WHAT INFORMATION DO WE COLLECT?</h2>

                    <h3 className="text-lg font-semibold text-gray-900 mt-6 mb-3">INFORMATION YOU PROVIDE TO US</h3>
                    <p>
                    ...
                    <h3 className="text-lg font-semibold text-gray-900 mt-6 mb-3">INFORMATION WE COLLECT AS YOU ACCESS AND USE OUR SERVICES</h3>
                    <p>
                    ...
                    <p>
                        In case of booking via call centre, Top4 may record calls for quality and training purposes.
                    </p>
                    <p>
                    ...
                    <h3 className="text-lg font-semibold text-gray-900 mt-6 mb-3">INFORMATION THIRD PARTIES PROVIDE ABOUT YOU</h3>
                    <p>
                    ...
                    <h3 className="text-lg font-semibold text-gray-900 mt-6 mb-3">INFORMATION COLLECTED BY MOBILE APPLICATIONS</h3>
                    <p>
                    ...
                    <h2 className="text-xl font-bold text-gray-900 mt-8 mb-4">USE OF INFORMATION COLLECTED</h2>
                    <p>
                    ...
                    <h2 className="text-xl font-bold text-gray-900 mt-8 mb-4">HOW AND WHEN DO WE DISCLOSE INFORMATION TO THIRD PARTIES</h2>
                    <p>
                    ...
                    <h3 className="text-lg font-semibold text-gray-900 mt-6 mb-3">(a). WHEN YOU AGREE TO RECEIVE INFORMATION FROM THIRD PARTIES.</h3>
                    <p>
                    ...
                    <h3 className="text-lg font-semibold text-gray-900 mt-6 mb-3">(b). THIRD PARTIES PROVIDING SERVICES ON OUR BEHALF</h3>
                    <p>
                    ...
                    <h3 className="text-lg font-semibold text-gray-900 mt-6 mb-3">(c). CO-BRANDED SERVICES</h3>
                    <p>
                    ...
                    <h3 className="text-lg font-semibold text-gray-900 mt-6 mb-3">(d). CONTESTS AND PROMOTIONS</h3>
                    <p>
                    ...
                    <h3 className="text-lg font-semibold text-gray-900 mt-6 mb-3">(e). ADMINISTRATIVE AND LEGAL REASONS</h3>
                    <p>
                    ...
                    <h3 className="text-lg font-semibold text-gray-900 mt-6 mb-3">(f). WHEN YOU SHARE INFORMATION</h3>
                    <p>
                    ...
                    <h3 className="text-lg font-semibold text-gray-900 mt-6 mb-3">(g). BUSINESS TRANSFER</h3>
                    <p>
                    ...
                    <h2 className="text-xl font-bold text-gray-900 mt-8 mb-4">THIRD PARTY CONTENT AND LINKS TO THIRD PARTY SERVICES</h2>
                    <p>
                    ...
                    <h2 className="text-xl font-bold text-gray-900 mt-8 mb-4">SOCIAL MEDIA FEATURES AND WIDGETS</h2>
                    <p>
                    ...
                    <h2 className="text-xl font-bold text-gray-900 mt-8 mb-4">INFORMATION COLLECTED BY DRIVERS</h2>
                    <p>
                    ...
                    <h2 className="text-xl font-bold text-gray-900 mt-8 mb-4">CHANGE OF INFORMATION AND CANCELLATION OF ACCOUNT</h2>
                    <p>
                    ...
                    <h2 className="text-xl font-bold text-gray-900 mt-8 mb-4">GRIEVANCE OFFICER</h2>
                    <p>
                        Top4 hereby appoints Top4 Support Manager as the grievance officer for the purposes of the rules drafted under the Information Technology Act, 2000, who may be contacted at <a href="mailto:top4calldriverservices@gmail.com" className="text-blue-600 hover:text-blue-800">top4calldriverservices@gmail.com</a>. You may address any grievances you may have in respect of this privacy policy or usage of your Protected Information or other data to him.
                    </p>

                    <h2 className="text-xl font-bold text-gray-900 mt-8 mb-4">CHANGES TO THE PRIVACY POLICY</h2>
                    <p>
