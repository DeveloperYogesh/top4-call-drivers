    ...
    <LocalizationProvider dateAdapter={AdapterDayjs}>
      <Container maxWidth="lg">
        <Box sx={{ mb: 4, textAlign: 'center' }}>
          ...
          >
            Hire verified professional drivers for hassle-free commutes and safe rides
          </Typography>
        </Box>
              ...
              <CardContent>
                ...
                <Box sx={{ mb: 4 }}>
                  ...
                  <DateTimePicker
                    ...
                    onChange={(newValue) => updateField('scheduledTime', newValue?.toDate() || null)}
                  ...
                  <Grid container spacing={3}>
                    ...
                    <Grid item xs={12} md={6}>
                      <FormControl fullWidth>
                        ...
                        <Select
                          value={vehicleSize}
                          onChange={(e) => updateField('vehicleSize', e.target.value as any)}
                        >
                  ...
                  <FormControlLabel
                    control={
                      <Checkbox
                        ...
                        onChange={(e) => updateField('damageProtection', e.target.checked)}
                      />
                    }
                    label={
                      <Box>
                ...
                <Box sx={{ mb: 3 }}>
                  <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 1 }}>
                    ...
                    <Typography variant="body2">
                      {formatCurrency(vehicleSizes.find(v => v.value === vehicleSize)?.price || 299)}
                    </Typography>
                  </Box>
                  ...
                  {damageProtection && (
                    <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 1 }}>
                      ...
                      <Typography variant="body2">{formatCurrency(50)}</Typography>
                    </Box>
                  )}
